...
model = WeeklyFinancialForecastingModel(log_path='logs/QQQ60L/QQQ60L_output_log_search.txt',
                                        ...
                                        output_path='results/QQQ60L/QQQ60L_output.csv')
...
with open('logs/QQQ60L/QQQ60L_best_configs_auto.py', 'w') as f:
...
with open('results/QQQ60L/QQQ60L_results.pkl', 'wb') as f:

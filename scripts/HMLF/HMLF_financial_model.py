...
# Add the best configurations from the HMLF model
...
model = WeeklyFinancialForecastingModel(log_path='logs/HMLF/HMLF_output_log_search.txt',
...
with open('logs/HMLF/HMLF_best_configs_auto.py', 'w') as f:
...
with open('results/HMLF/HMLF_results.pkl', 'wb') as f:

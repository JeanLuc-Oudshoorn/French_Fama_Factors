...
from logs.QQQ60_5.QQQ60_5_best_configs_auto import best_configs
import datetime
import pprint
import os
...
model = WeeklyFinancialForecastingModel(log_path='logs/QQQ60_5/QQQ60_5_output_log_search.txt',
                                        ...
                                        output_path='results/QQQ60_5/QQQ60_5_output.csv')
...
with open('logs/QQQ60_5/QQQ60_5_best_configs_auto.py', 'w') as f:
...
with open('results/QQQ60_5/QQQ60_5_results.pkl', 'wb') as f:
...
model.future_preds['MEAN_PRED_PROBA'].to_csv(f'logs/QQQ60_5/QQQ60_{date_str}.csv')

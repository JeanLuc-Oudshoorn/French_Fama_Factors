...
y_test = french_fama[french_fama.index >= '1967-01-01']['HML_1_INDICATOR']
y_pred = french_fama[french_fama.index >= '1967-01-01']['DUM_PRED_CLS']

# Create rolling accuracy of predictions
french_fama.loc['1967-01-01':, 'DUM_CORRECT'] = (y_test == y_pred)
...
y_test = french_fama[french_fama.index >= '1967-01-01']['HML_1_INDICATOR']
y_pred = french_fama[french_fama.index >= '1967-01-01']['REAL_PRED_CLS']

# Create rolling accuracy of predictions
french_fama.loc['1967-01-01':, 'REAL_CORRECT'] = (y_test == y_pred)

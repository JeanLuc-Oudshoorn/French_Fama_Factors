...
french_fama['HML_1'] = french_fama['HML'].shift(-3)

# Fill HML 1
french_fama.loc['2023-09-01', 'HML_1'] = 1
...
y_test = french_fama[(french_fama.index >= '1985-01-01') & (french_fama.index <= '2023-06-01')]['HML_1_INDICATOR']
